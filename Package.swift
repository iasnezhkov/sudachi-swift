...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/iasnezhkov/sudachi-swift/releases/download/v0.1.1/Sudachi.xcframework.zip",
            checksum: "5f17105e7ec602413fc8c72e6a44d273758b36fa8da17edc3f6b0cc43983984e"
        ),
        .target(
            name: "Sudachi",
