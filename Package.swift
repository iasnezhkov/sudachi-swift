...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/iasnezhkov/sudachi-swift/releases/download/v0.2.0-rc1/Sudachi.xcframework.zip",
            checksum: "87789f450beecb7854b0cfecb9247e40ee505a24d538a1dcad368a0203322ebf"
        ),
        .target(
            name: "Sudachi",
