...
#if canImport(suji_sudachiFFI)
import suji_sudachiFFI
#endif
...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_suji_sudachi_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_suji_sudachi_rustbuffer_free(self, $0) }
    }
}
...
private func makeRustCall<T, E: Swift.Error>(
    ...
    uniffiEnsureSujiSudachiInitialized()
...
open class SudachiDictionary: SudachiDictionaryProtocol, @unchecked Sendable {
    ...
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_suji_sudachi_fn_clone_sudachidictionary(self.handle, $0) }
    }
public convenience init(systemDictPath: String, userDictPaths: [String], resourceDir: String)throws  {
    ...
    uniffi_suji_sudachi_fn_constructor_sudachidictionary_new(
    ...
    deinit {
        ...
        try! rustCall { uniffi_suji_sudachi_fn_free_sudachidictionary(handle, $0) }
    }
...
#endif
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_suji_sudachi_fn_clone_sudachitokenizer(self.handle, $0) }
    }
public convenience init(dictionary: SudachiDictionary, mode: SplitMode)throws  {
    let handle =
        try rustCallWithError(FfiConverterTypeSudachiError_lift) {
    uniffi_suji_sudachi_fn_constructor_sudachitokenizer_new(
    ...
    deinit {
        ...
        try! rustCall { uniffi_suji_sudachi_fn_free_sudachitokenizer(handle, $0) }
    }
...
open func tokenizeWithMode(text: String, mode: SplitMode)throws  -> [Morpheme]  {
    return try  FfiConverterSequenceTypeMorpheme.lift(try rustCallWithError(FfiConverterTypeSudachiError_lift) {
    uniffi_suji_sudachi_fn_method_sudachitokenizer_tokenize_with_mode(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(text),
        FfiConverterTypeSplitMode_lower(mode),$0
    )
...
public struct Morpheme: Equatable, Hashable {
    ...
    public init(surface: String, readingForm: String, dictionaryForm: String, normalizedForm: String, partOfSpeech: [String], synonymGroupIds: [UInt32], isOov: Bool, wordId: UInt32, begin: UInt32, end: UInt32) {
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_suji_sudachi_uniffi_contract_version()
    if bindings_contract_version != scaffolding_contract_version {
        return InitializationResult.contractVersionMismatch
    }
    if (uniffi_suji_sudachi_checksum_func_katakana_to_hiragana() != 47003) {
    ...
    if (uniffi_suji_sudachi_checksum_constructor_sudachidictionary_new() != 18523) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_suji_sudachi_checksum_constructor_sudachitokenizer_new() != 29323) {
        return InitializationResult.apiChecksumMismatch
    }
...
public func uniffiEnsureSujiSudachiInitialized() {
